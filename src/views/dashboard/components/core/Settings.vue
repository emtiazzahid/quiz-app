...
<script>
  ...
  export default {
    ...
    data: () => ({
      ...
      image: 'https://demos.creative-tim.com/material-dashboard-bs4/assets/img/sidebar-1.jpg',
      images: [
        'https://demos.creative-tim.com/material-dashboard-bs4/assets/img/sidebar-1.jpg',
        'https://demos.creative-tim.com/material-dashboard-bs4/assets/img/sidebar-2.jpg',
        'https://demos.creative-tim.com/material-dashboard-bs4/assets/img/sidebar-3.jpg',
        'https://demos.creative-tim.com/material-dashboard-bs4/assets/img/sidebar-4.jpg',
      ],
      menu: false,
      saveImage: '',
      showImg: true,
